...
export interface ApiCampCamp extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    services: Schema.Attribute.Component<'shared.text-item', true>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    spots: Schema.Attribute.Enumeration<
      ['Ausgebucht', 'Wenige Pl\u00E4tze', 'Freie Pl\u00E4tze']
    > &
      Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Adress- und Kontaktdaten f\u00FCr Website';
    displayName: 'Kontakt';
    pluralName: 'contacts';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ageGroup: Schema.Attribute.String & Schema.Attribute.Required;
    camp: Schema.Attribute.Relation<'manyToOne', 'api::camp.camp'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['Neu', 'Bald voll', 'Ausgebucht']> &
      Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiImpressumImpressum extends Struct.SingleTypeSchema {
  collectionName: 'legal_imprints';
  info: {
    description: 'Impressumsangaben';
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    requirements: Schema.Attribute.Component<'shared.text-item', true>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiLandingLanding extends Struct.SingleTypeSchema {
  collectionName: 'landing_settings';
  info: {
  ...
  attributes: {
    ...
    heroPrimaryUrl: Schema.Attribute.String;
    heroSecondaryLabel: Schema.Attribute.String;
    heroSecondaryUrl: Schema.Attribute.String;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Sozial- & Spendenprojekte';
    displayName: 'Spendenprojekt';
    pluralName: 'projects';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    photo: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
